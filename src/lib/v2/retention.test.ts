// Vitest-svit för S8:s ENHETLIGA retention-logik — kund-lanen + verkstads-lanen.
// Testar den faktiska modulen som edge-funktionerna använder
// (supabase/functions/_shared/v2/retention.ts) plus frontend-hjälparna i
// src/lib/v2/retention.ts. Samma parity-mönster som contracts.test.ts.
// Sammanslagen svit (merge v2/customer-retention + v2/workshop-retention):
// 36 kund-tester + 43 verkstads-tester = 79 tester.
