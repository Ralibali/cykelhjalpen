  ...
  public: {
    Tables: {
      ...
      v2_service_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "v2_service_orders_source_response_id_fkey"
          ...
          {
            foreignKeyName: "v2_service_orders_workshop_id_fkey"
            columns: ["workshop_id"]
            isOneToOne: false
            referencedRelation: "workshops"
            referencedColumns: ["id"]
      ...
      workshop_quote_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "workshop_quote_tokens_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
            referencedRelation: "bike_repair_requests"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "workshop_quote_tokens_workshop_id_fkey"
            columns: ["workshop_id"]
            isOneToOne: false
            referencedRelation: "workshops"
            referencedColumns: ["id"]
