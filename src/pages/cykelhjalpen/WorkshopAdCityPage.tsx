...
const WorkshopAdCityPage = () => {
  ...
  const pageDesc = t('Anslut din verkstad i {city} till Cykelhjälpen. Få kvalificerade leads direkt i inboxen – det kostar inget att svara, du betalar bara {fee} kr exkl. moms när kunden väljer dig. Ingen månadskostnad, ingen bindning.', { city: city.name, fee: feeKr })
  ...
  const benefits = [
    ...
    { icon: TrendingUp, title: t('Bara {fee} kr vid vinst', { fee: feeKr }), body: t('Ingen månadskostnad. Ingen provision. Det kostar inget att svara – du betalar bara när kunden väljer dig.') },
  ...
  const steps = [
    ...
    { title: t('Svara på det som passar'), body: t('Lämna offert med ett klick – helt kostnadsfritt. Vinner du ärendet kostar det {fee} kr exkl. moms, eller så dras ett gratis-lead.', { fee: feeKr }) },
          ...
          <div className="grid lg:grid-cols-[1.05fr_.95fr] gap-10 items-center">
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-8">
                {t('Vi skickar kvalificerade kundförfrågningar direkt till din verkstad. Det kostar inget att svara – du betalar bara')} <strong className="text-foreground">{t('{fee} kr exkl. moms när kunden väljer dig', { fee: feeKr })}</strong>. {t('Ingen månadskostnad, ingen bindning.')}
              </p>
            ...
            >
              ...
              <div className="absolute -bottom-5 left-6 sticker rounded-2xl bg-card px-5 py-4">
                <p className="font-display text-3xl leading-none">{feeKr} kr</p>
        ...
        <div className="max-w-2xl mx-auto px-4">
          <Reveal>
            <div className="sticker rounded-[2rem] bg-[hsl(var(--brand-dark))] p-8 md:p-12 text-center text-background">
              ...
              <div className="font-display text-6xl mb-2">{feeKr} kr</div>
