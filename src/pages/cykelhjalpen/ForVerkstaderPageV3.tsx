...
const ForVerkstaderPageV3 = () => {
  ...
  const isLinkoping = city === 'Linköping'
          ...
          <div className="container mx-auto px-4 py-14 md:py-20 max-w-6xl grid lg:grid-cols-[1fr_.9fr] gap-10 items-center">
            <div>
              ...
              <div className="mt-7 rounded-2xl border-2 border-primary/30 bg-background/80 p-5 max-w-2xl">
                <p className="font-semibold flex items-center gap-2"><MapPin className="h-4 w-4 text-primary" />{isLinkoping ? text('Linköping är vår prioriterade stad just nu', 'Linköping is our priority city right now') : text(`Vi bygger partnernätverket i ${city} just nu`, `We are building the partner network in ${city} right now`)}</p>
...
export default ForVerkstaderPageV3
