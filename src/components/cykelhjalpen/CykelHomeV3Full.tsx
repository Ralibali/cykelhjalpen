    ...
    <section className="py-20 md:py-24 bg-muted/30">
      <div className="container mx-auto px-4 max-w-6xl grid lg:grid-cols-[.8fr_1.2fr] gap-10 items-center">
        <div>
          ...
          <Button asChild size="lg" className="mt-8 rounded-full h-14 px-8"><Link to="/skicka-arende" onClick={() => trackClick('home_v3_quote_preview_cta', 'Starta ärende')}>{text('Starta kostnadsfritt ärende', 'Start a free request')} <ArrowRight className="h-4 w-4 ml-2" /></Link></Button>
        </div>
