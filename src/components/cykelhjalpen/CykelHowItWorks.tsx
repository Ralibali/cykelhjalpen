...
const CykelHowItWorks = () => (
  <section id="sa-fungerar-det" className="py-20 bg-background/60">
    <div className="container mx-auto px-4 max-w-6xl">
      ...
      <div className="grid md:grid-cols-3 gap-5">
        {[
          ...
          { icon: MessageSquare, title: 'Ta emot prisförslag', text: 'Godkända verkstäder i din stad kan svara med pris och beräknad tid.' },
