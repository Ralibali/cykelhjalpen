  ...
  <section id="stader" className="py-20">
    <div className="container mx-auto px-4 max-w-6xl">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
        ...
        <p className="text-muted-foreground max-w-md">Läs om lokal cykelhjälp i din stad och gå sedan vidare till ett kostnadsfritt ärende.</p>
      </div>

      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {CYKEL_CITIES.map((city) => (
          <Link key={city.name} to={cityLandingPath(city.name)} className="sticker bg-card rounded-2xl p-5 hover:-translate-y-1 transition-transform">
